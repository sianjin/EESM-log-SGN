...
methods
    ...
    function snrEffVec = effectiveSinrVec(abstraction,sinrStore,beta)
        ...
        for pktIdx = 1: numPkts 
            ...
            snrEffVec(pktIdx) = 10*log10(snreff);
        end
        
    end
    
    function snrEff = eesmEffectiveSINR(abstraction,sinr,beta)
        % SNREFF = effectiveSINR(ABSTRACTION,SINRSTORE,BETA) returns
        % the effective SNR vector.
        %
        % SINR is the SINR per subcarrier, spatial stream.

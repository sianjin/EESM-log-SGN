...
[effSnrIntSGNdB2,perFastAbsInt2] = logSGNGeneration(abstraction,coding,mcs,dataLength,format,xBestInt);
effSnrIntSGNLinear2 = 10.^(effSnrIntSGNdB2/10); % interference 2
effSnrIntSGNLinear = {effSnrIntSGNLinear1,effSnrIntSGNLinear2}; % Put all interference at here

function out = rbirPERPredictionMUBeamforming(simParams)
...
snr = simParams.SNR;
mcs = simParams.MCS;
rbirParameters = simParams.RbirParameters;
...
%     end
    ...
    snrEff = rbirEffectiveSINR(Abstraction,sinr,'HE_MU',mcs,rbirParameters(1),rbirParameters(2));

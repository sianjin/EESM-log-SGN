function simParams = getBox0SimParams(chans,numTxRx,mcs,cfgHE,maxNumErrors,maxNumPackets,userIdx,ruIdx,Nsts,beta)
...
simParamsRef = struct('MCS',0,'SNR',0,'RandomSubstream',0,'Config',cfgHE, ...
    ...
    'Channel',tgaxChannel,'userIdx',userIdx,'ruIdx',ruIdx,'beta',beta);
